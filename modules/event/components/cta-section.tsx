  ...
  return (
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        {/* CTA Button */}
        <Button className="px-6 h-15 rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:-translate-y-1 bg-gradient-primary text-white hover:opacity-90 shadow-lg shadow-primary/30">
          Sign up for free
        </Button>
